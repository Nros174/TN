...
public class StudentController {
	...
	public @ResponseBody ResponseEntity<Object> addStudents(@RequestBody Student s) {

		Student reltStudent = studentService.add(s);
		return ResponseEntity.status(HttpStatus.CREATED).body(reltStudent);
	}
}
